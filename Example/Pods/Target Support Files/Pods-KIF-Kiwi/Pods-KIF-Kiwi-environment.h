...
// KIF-Kiwi
#define COCOAPODS_POD_AVAILABLE_KIF_Kiwi
#define COCOAPODS_VERSION_MAJOR_KIF_Kiwi 0
#define COCOAPODS_VERSION_MINOR_KIF_Kiwi 2
#define COCOAPODS_VERSION_PATCH_KIF_Kiwi 2
